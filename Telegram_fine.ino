...
#define WIFI_PASSWORD "xx"                //inserire PASSWORD WIFI
 

// Telegram BOT Token (Get from Botfather)
#define BOT_TOKEN "xx"                   //Inserire bot Telegram
...
void setup() {
 ...
 bmx280.writeOversampliPressure(BMx280I2C::OSRS_P_x16);
}
...
void VisualizzaSeriale(){
  ...
  String data =   "Temperatura: "    +String(temperatura)+   "Â°C \n";
         ...
         data +=  "La pressione è: " +String(pressure);
